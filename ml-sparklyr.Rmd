...
``` {r spark-copy, eval=TRUE, message=FALSE, warning=FALSE}
glimpse(iris)
...
``` {r spark-tibble, eval=TRUE, message=FALSE, warning=FALSE}
...
``` {r spark-dplyr, message=FALSE, warning=FALSE}
...
``` {r spark-dplyr-advanced, message=FALSE, warning=FALSE}
# 3. 고급 데이터 처리 ------------------------------------------
## 3.1. select 
...
``` {r spark-dataframe-checkpoint, message=FALSE, warning=FALSE}
...
``` {r spark-dataframe-factor, message=FALSE, warning=FALSE}
# 1. 스파크 데이터프레임 스키마
...
``` {r spark-dataframe-ml, message=FALSE, warning=FALSE}
# 1. 기계학습 -----------------------------------------------
## 1.1. 표본추출 --------------------------------------------
iris_sdf_tbl %>% 
