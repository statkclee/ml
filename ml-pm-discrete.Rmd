...
```{r fundraising-data-fit-performance}
library(broom)
library(extrafont)
loadfonts()
...
```{r fundraising-data-fit-performance-lift}
ggplot(df_lift$data) +
...
```{r fundraising-pig-all, eval=FALSE}
