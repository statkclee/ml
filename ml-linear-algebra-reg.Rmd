...
# 회귀분석 [^advanced-linear-model] {#linear-algebra-reg}

 기초 선형대수를 통해 회귀분석을 이해하고, 선형대수 수학식을 R 언어로 구현한다.
...
``` {r r-galton-hegith-linear-algebra}
## 2. 회귀분석
# 선형대수 수식으로 계산
